-- Bukti Dukung v2:
--   * Daftar petugas TIDAK termasuk role admin.
--   * Termin 1  : bukti 'fasih' terakhir dengan created_at <  2026-08-01 (s/d Juli).
--   * Termin 2  : bukti 'fasih' terakhir dengan created_at >= 2026-08-01 (mulai Agustus).
--                 -> upload bulan Juli tidak lagi masuk Termin 2.
--   * Paket data: bukti 'bukti paket data' terakhir.
--
-- Akses: admin -> semua petugas non-admin; pengawas -> petugas binaannya.
