-- Tambah info wilayah SLS (nm_sls, sub_sls) dan nama PPL ke get_anomali_gabungan.
--
-- - nm_sls / sub_sls: untuk melengkapi chip wilayah di kartu anomali supaya
--   tidak sekadar kode 16 digit.
-- - nama_petugas: nama PPL pemilik wilayah (dari se2026_wilayah_tugas.ppl_id),
--   HANYA diisi untuk role 'pengawas'/'admin' (PML/admin) supaya mereka tahu
--   petugas mana yang harus diminta memperbaiki di Fasih. Untuk 'pendata'
--   dikosongkan (mereka hanya melihat wilayahnya sendiri).
--
-- Tetap versi pusat_baru-only (kualitas/pusat dinolkan sementara, lihat
-- 20260706130000). Mengembalikan 3 sumber: jalankan 20260703190000 lalu
-- terapkan kembali penyesuaian yang diinginkan.
...
begin
    ...
    -- Nama PPL hanya untuk PML/admin.
    v_petugas_col := case
