-- Kolom `deskripsi` pada get_anomali_gabungan (baris pusat_baru) sebelumnya
-- hanya berisi t.kategori_nama -- persis sama dengan kategori_label, jadi
-- tidak menambah informasi apa pun di detail sheet.
--
-- Ubah: ambil deskripsi_rule dari anomali_pusat_kategori (kalimat aturan
-- lengkap hasil registrasi import, mis. "Jumlah Anomali Data 1 (Biaya
-- Produksi Dominan) belum ditindaklanjuti"), fallback ke kategori_nama
-- kalau kategori belum terdaftar / deskripsi_rule kosong.
--
-- Hanya baris deskripsi + 1 join yang berubah; sisa fungsi identik dengan
-- 20260708140000_anomali_gabungan_respons_agg.sql.
