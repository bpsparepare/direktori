-- Tambahkan filter kode_bang IS NOT NULL pada kedua RPC titik assignment yang
-- bersumber dari se2026_keterangan_umum. Hanya baris dengan kode_bang TERISI
...
-- 2) RPC lama (full / incremental, dipakai tombol download).
