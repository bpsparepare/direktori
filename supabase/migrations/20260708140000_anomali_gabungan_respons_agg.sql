-- Tambah agregat respons semua petugas per kasus untuk keperluan ekspor:
--   jenis_semua      : daftar jenis_respons (berlabel) dari SEMUA respons.
--   keterangan_semua : gabungan "Nama (Jenis): keterangan" dari SEMUA respons.
-- Menggantikan definisi di 20260708130000 (menambah 2 kolom di akhir).
